...
const PrivacyPolicy = () => {
  return (
    ...
    <ul>
    <li>
    <p>By email: <a href="mailto:monomzapp@gmail.com">monomzapp@gmail.com</a></p>
    </li>
    <li>
    <p>By visiting <a href="/support" rel="external nofollow noopener noreferrer" target="_blank">this page</a> on our website</p>
    </li>
    </ul>
    </main>
  )
